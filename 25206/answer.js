...
const { totalGradePointSum, totalGradeSum } = reportCard.reduce((acc, cur)  => {
  const [grade, gradePoint] = cur;
  const gradePointResult = grade * gradePoint;
  return { totalGradePointSum: acc.totalGradePointSum + gradePointResult, totalGradeSum: acc.totalGradeSum + grade };
